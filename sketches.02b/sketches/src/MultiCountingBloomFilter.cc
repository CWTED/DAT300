...
Sketches::MultiCountingBloomFilter::MultiCountingBloomFilter(
...
Sketches::MultiCountingBloomFilter::MultiCountingBloomFilter(const byte* data)
{
...
Sketches::MultiCountingBloomFilter&
Sketches::MultiCountingBloomFilter::operator=(
...
void Sketches::MultiCountingBloomFilter::insert(const std::string& id, byte val)
{
	if (m_type == HT_UNIVERSAL)
	{
...
void Sketches::MultiCountingBloomFilter::insert(
